...
class RoadQualityDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        seg = self._load_segmentation(paths['segmentation'])
        severity = self._load_severity(paths['severity'])
        camera_params = self._load_camera(paths['camera_params'])
    ...
    def _load_camera(self, path_str: str) -> Dict:
        ...
        # Handle the actual renderer output format
        if 'intrinsics_K' in data:
            ...
            # Fallback for old/mocked formats
