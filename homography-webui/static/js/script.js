            ...
            geoJsonLayer = L.geoJSON(null, {
                ...
                pointToLayer: (feature, latlng) => {
                    const marker = L.circle(latlng, {
                        radius: 1, fillColor: "#2563eb", color: "#ffffff", weight: 2, opacity: 1, fillOpacity: 1        
                    });
        ...
        try {
            ...
            setTimeout(() => {
                ...
                data.initial_state.forEach(img => {
                    if(img.lat !== 0.0) {
                        const marker = L.circle([img.lat, img.lon], {
                            radius: 1, fillColor: "#ff0000", color: "#ffffff", weight: 2, opacity: 1, fillOpacity: 1
                        }).addTo(map);
