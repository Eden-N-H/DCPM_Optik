...
def create_project_zip(project_state, upload_folder):
    ...
    with zipfile.ZipFile(memory_file, 'w', zipfile.ZIP_DEFLATED) as zf:
        ...
        for f in os.listdir(upload_folder):
            ...
            for b in base_names:
                # Strictly isolate files generated by this exact filename stem, ensuring 
                # overlapping base-names (like 'frame1' vs 'frame10') aren't entangled
                if re.search(rf"(^|_){re.escape(b)}(\.|$|_)", f):
